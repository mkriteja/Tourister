...
public class DetailActivity extends Activity {
    ...
    private void applyPalette(Palette palette) {
        int DEFAULT_BACKGOUND = Color.parseColor("#00897B");
        int DEFAULT_VAL = getColor(R.color.white);
        getWindow().setBackgroundDrawable(new ColorDrawable(palette.getDarkMutedColor(DEFAULT_BACKGOUND)));
